<?php
  ...
  //$messages_q = $conntr->Slecet($ecommun ,"message_contents","*","type='privee' AND CID = '$id' "); // lazem nzidouha UserKey = User key elli fi session 
  //$messages_num = mysqli_num_rows($messages_q)
    
  $sql = "SELECT * FROM message_contents  WHERE  type = 'privee' AND CID = '$id' ;";
...
<body>
    <div class="card card-body shadow-sm rounded-0 border-0 fixed-top">
       <h4 class="text-secondary">Message Priveé <span class="bi bi-alarm"></span></h4> 
    </div>
    <br/>
    <br/>
    <br/>
        ...
        <div class='row '>
            ...
            <?php
                ...
                echo '
                    <div class="card p-2 border-2 mb-3" >
                        <h5>'.$result['M_Date'].' -- '.$result['M_Time'].' </h5>
            ...
            <div class='col-4'>
                <div class='card card-body shadow-sm mb-4 rounded'>
                    ...
                    <form action="ajouter_message_privee.php"  method="post"  >
